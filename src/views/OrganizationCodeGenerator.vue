      ...
      <section class="page-header" aria-labelledby="page-title">
        <div class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="breadcrumb-current">
            <span itemprop="name">{{ t('organizationCode', currentCountry) }}</span>
        ...
        <h1 id="page-title" class="page-title" itemprop="headline">
          ...
          {{ t('organizationCode', currentCountry) }}
        </h1>
        <p class="page-description" itemprop="description">
          {{ t('organizationCodeGeneratorDescription', currentCountry) }}
        </p>
      </section>

      <section class="generator-section" aria-labelledby="generator-title">
        <OrganizationCodeGeneratorComponent :currentCountry="currentCountry" />
      </section>
    </main>
...
import OrganizationCodeGeneratorComponent from '@/components/OrganizationCodeGenerator.vue';
